...
from pindiode_cband import pindiode_cband


class dc_mzi_2x2_pindiode_cband:
    ...
    def get_component(self):
        ...
        pin1 = c << pindiode_cband(config={"length": self.length}).component
        pin2 = c << pindiode_cband(config={"length": self.length}).component
...
if __name__ == "__main__":
    ...
    c = dc_mzi_2x2_pindiode_cband(config={"length": 320})
