...
from heater_doped_si_oband import heater_doped_si_oband


class mzi_1x1_heater_doped_si_oband:
    ...
    def get_component(self):
        ...
        heater = heater_doped_si_oband(config={"length": self.length}).component
