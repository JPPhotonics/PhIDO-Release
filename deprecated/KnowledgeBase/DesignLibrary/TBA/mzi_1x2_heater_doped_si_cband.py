"""
Name: MZI 1x2 - Thermo-optic Doped Silicon
Description: >
...
Footprint Estimate: 469.02um x 90.05um
"""
...
@gf.cell
def mzi_1x2_heater_doped_si_cband(settings: dict = {}):
    length = 320
    c = gf.Component()
...
if __name__ == "__main__":
    ...
    c = mzi_1x2_heater_doped_si_cband({"length": 100.4})
    c.plot()
    plt.show()
