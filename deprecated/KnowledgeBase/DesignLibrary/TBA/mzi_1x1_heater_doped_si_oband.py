...
Footprint Estimate: 456.02um x 90.12um
"""

import gdsfactory as gf

from PhotonicsAI.KnowledgeBase.DesignLibrary import heater_doped_si_oband


@gf.cell
def mzi_1x1_heater_doped_si_oband(settings: dict = {}) -> gf.Component:
    length = 320
    c = gf.Component()
    ...
    heater = heater_doped_si_oband.heater_doped_si_oband({"length": length})
...
if __name__ == "__main__":
    ...
    c = mzi_1x1_heater_doped_si_oband()
    c.plot()
    plt.show()
