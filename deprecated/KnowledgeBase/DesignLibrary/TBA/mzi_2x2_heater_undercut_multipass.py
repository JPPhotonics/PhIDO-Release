"""
Name: MZI 2x2 - Thermo-optic with undercut and multipass
Description: >
    This is a 2x2 Mach-Zehnder interferometer (MZI) that uses 2x2 MMIs.
    Integrated in both arms of the MZI are TiN heaters with substrate undercut.
    The waveguide passes through the heater three times.
ports: 2x2
NodeLabels:
    - modulator
    - active
...
@gf.cell
def mzi_2x2_heater_undercut_multipass(settings: dict = {}):
    dy = 80
    coupling1 = 0.5
    coupling2 = 0.5
    delta_length = 50
...
if __name__ == "__main__":
    ...
    c = mzi_2x2_heater_undercut_multipass({"length": 100.4})
    c.plot()
    plt.show()
