"""This module defines a heater with a Titanium nitride heating element for a thermo-optic phase shifter.
...
def heater_tin_cband(
    ...
    _mh = c << gf.path.straight(length=length).extrude(mh_xs)
